...
<body>
    ...
    <form action="EmployeeRegisterClean" method="post" id="employeeForm">
        ...
        <input type="text" name="employeeName" id="employeeName" placeholder="Name" value="<%=employeeName%>" readonly>
        <input type="text" name="employeeLastName" id="employeeLastName" placeholder="Last name" value="<%=employeeLastName%>" readonly>
        <input type="number" name="employeeAge" id="employeeAge" min="0" max="130" placeholder="Age" value="<%=employeeAge%>" readonly>
        <input type="date" name="employeeBirthDay" id="employeeBirthDay" placeholder="BirthDay" value="<%=employeeBirthDate%>" readonly>
        <input type="submit" name="employeeStore" id="employeeStore" value="Yes, I want to delete It!"> 
    </form>
</body>
</html>